...
* *Участник офлайн мероприятия – Летний день стажёра от Яндекса 2023 ( прошёл алгоритмический контест из двух задач)*
* *Призёр в команде олимпиады по спортивному программированию RuCode 2023*
