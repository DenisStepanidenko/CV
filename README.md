...
* *Успешно прошёл онлайн-интенсив (с прохождением в офлайн часть) **летнего ИТ-лагеря Холдинга T1** в период с 4 июня по 5 июля 2024 года по программе : **Разработка Backend (Java)*** ([*сертификат*](https://github.com/DenisStepanidenko/CV/blob/master/images/44-503075352.pdf))
...
* [***Task Tracker Api***](https://github.com/DenisStepanidenko/task-tracker-api) :zap:   
   ***Краткое описание***: В данной работе я реализовал небольшой API для сервисов, которые управляют списком задач (например такие, как Trello). Язык программирования - ***Java*** :coffee: 
...
* [***Задачи с курса по алгоритмам на Codeforces от ITMO***](https://github.com/DenisStepanidenko/ITMO-Codeforces-Course) :sparkling_heart:    
  ***Краткое описание***: В данном репозитории собраны задач по алгоритмам в рамках курса на Codeforces от ITMO. Язык программирования - ***Java*** :coffee:
* [***Тренировки по алгоритмам Яндекс 5.0***](https://github.com/DenisStepanidenko/Yandex-Training5.0) :yum:   
  ***Краткое описание***: В данном репозитории собраны задачи по алгоритмам в рамках тренировок от Яндекса по алгоритмам 5.0. Язык программирования - ***Java*** :coffee:
* [***Задачи по SQL с LeetCode***](https://github.com/DenisStepanidenko/SQL-Exercises-LeetCode) :blush:    
  ***Краткое описание***: В данном репозитории собраны задачи на написание запросов SQL с сайта LeetCode. Язык программирования - ***SQL*** :snowflake:
...
* *Участник офлайн мероприятия – Летний день стажёра от Яндекса 2023 ( прошёл алгоритмический контест )* :white_check_mark:
...
* *Победитель муниципального этапа Всероссийский олимпиады школьников по математике 2021 г.* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/победитель%20муниципа.pdf)) :dragon_face:
* *4 место на региональном этапе Всероссийской олимпиады школьников по математике 2021 г.* :dragon_face:
* *Похвальная грамота на олимпиаде Физтех по математике 2021 г. (1 балла не хватило до призёра 3 степени)* ([*диплом с онлайн этапа*](https://github.com/DenisStepanidenko/CV/blob/master/images/MIPT_diploma_2.pdf)) :dragon_face:
* *Призёр школьного этапа Всероссийской олимпиады школьников по информатике 2020 г.* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/призёр%20школьного%20по%20информатике.pdf)) :dragon_face:

# Математические олимпиады в вузе :gem:
* *Серебро в международной олимпиаде по математике (OMOUS) 2023 в Туркменистане* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/туркменистан.pdf)) :sparkler:
* *Призёр 3 степени X Всероссийской олимпиады по элементарной геометрии* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/геометрия.pdf)) :sparkler:
* *Бронзовый призёр девятой North Universities Mathematical Competition (NCUMC)* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/noth.pdf)) :sparkler:
* *Бронзовый призёр международной олимпиады в РУДН 2023 г.* ([*диплом*](https://github.com/DenisStepanidenko/CV/blob/master/images/рудн%20математика.pdf)) :sparkler:

# Опыт прохождения собеседований :office:
* *Проходил техническое собеседование в Яндекс* 
* *Проходил техническое собеседование в Крок*


# Опыт работы :pushpin:
* *C 2021 г. по 2023 г. работал куратором по математике в онлайн школе Школково (с 1 курса по середину 3 курса)*
* *с 2023 г. работаю лаборантом в математической учебно-проектной лаборатории "Аналитические методы исследования прикладных задач" в своём университете (ФГБОУ ВО "РЭУ ИМ. Г.В. ПЛЕХАНОВА")*
